...
{
    public class SpeechRecognitionFakeService : ISpeechRecognitionService
    {
        ...
        public SpeechRecognitionFakeService(
            ...
            ILogger logger)
        {
            ...
            _logger = logger.ForContext<SpeechRecognitionFakeService>();
        }
