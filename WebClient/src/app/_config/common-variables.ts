...
export class CommonVariables {
    ...
    public static B2CAccessTokenKey: string = "b2c.access.token";
    ...
    public static LoginRedirectUri: string = isDevMode()
        ? "http://localhost:4200/home/register-user/"
        : "https://rewrite-me.com/home/register-user/";
}
